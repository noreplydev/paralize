export default function Home() {
  return (
    <main className="h-screen w-screen bg-neutral-950 flex flex-col items-center justify-center
      bg-grid bg-cover">
      <h1 className="font-medium text-[#FFB23E] text-5xl mb-6 z-10">Paralize</h1> 
      <h1 className="font-light text-white text-2xl mb-10 z-10">Live demo of Next.js 13 parallel routes</h1> 
      ...
      <p className="text-[#d9d9d9] px-5 py-2 rounded-md border-solid border 
        border-[#ffb23e] bg-[#ffb23e21] cursor-pointer z-10"
      >Go to 
